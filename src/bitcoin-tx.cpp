...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s felixcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  felixcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded felixcoin transaction") + "\n" +
              "  felixcoin-tx [options] -create [commands]   " + _("Create hex-encoded felixcoin transaction") + "\n" +
              "\n";
