...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Felixcoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Felixcoin (as there is no actual maximum coins)
