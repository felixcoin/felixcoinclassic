Felixcoin Core version 1.14.3 is now available from:

  <https://github.com/felixcoin/felixcoin/releases/tag/v1.14.3/>
...
Block download timeouts are expressed as a multiple of block interval, and as such Felixcoin block download times were relatively aggressive, leading to a high number of timeouts. Increased the timeouts to be more flexible to real world conditions.
...
* Change IPC prefix from `bitcoin:` to `felixcoin:`.
