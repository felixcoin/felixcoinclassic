...
void Shutdown()
{
    ...
    RenameThread("felixcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Felixcoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/felixcoin/felixcoin>";
    const std::string URL_WEBSITE = "<https://felixcoin.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("felixcoin-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Felixcoin: Do we need to do any RPC mining init here?
